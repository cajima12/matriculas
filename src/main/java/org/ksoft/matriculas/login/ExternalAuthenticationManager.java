...
import org.ksoft.matriculas.repositorio.PeticionLoginRepositorio;
...
public class ExternalAuthenticationManager  implements AuthenticationManager {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		if (authentication instanceof UsernamePasswordAuthenticationToken) {
			try {
				MatriculasUser user = (MatriculasUser) customUserDetailsService.loadUserByUsername(authentication.getName());
