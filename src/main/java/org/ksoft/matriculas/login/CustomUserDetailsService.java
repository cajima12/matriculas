...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    	...
    	org.ksoft.matriculas.modelo.Usuario domainUser = usuarioRepositorio.findByUsernameAndVerificadoTrue(username);
		if (domainUser == null) {
		...
		if (!auths.isEmpty()) {
			...
			return new MatriculasUser(domainUser.getUsername(), domainUser.getPassword(), enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, auths,
					domainUser);
		}
